...
// DateTime: 5/25/2014 2:20:55 PM
// UserName: bill
// Input file <CbParser.y - 5/25/2014 2:20:52 PM>
...
public enum Tokens {error=126,
    ...
    Kwd_if=139,Kwd_int=140,Kwd_new=141,Kwd_null=142,Kwd_out=143,Kwd_override=144,
    Kwd_public=145,Kwd_return=146,Kwd_static=147,Kwd_string=148,Kwd_using=149,Kwd_virtual=150,
    Kwd_void=151,Kwd_while=152,PLUSPLUS=153,MINUSMINUS=154,Ident=155,Number=156,
    StringConst=157};
...
#pragma warning restore 649
  ...
  static Parser() {
    states[0] = new State(new int[]{149,183,136,-3,145,-3},new int[]{-1,1,-3,3});
    states[1] = new State(new int[]{127,2});
    states[2] = new State(-1);
    states[3] = new State(new int[]{136,6,145,174},new int[]{-4,4,-5,182});
    states[4] = new State(new int[]{136,6,145,174,127,-2},new int[]{-5,5});
    states[5] = new State(-5);
    states[6] = new State(new int[]{155,7});
    states[7] = new State(new int[]{123,8});
    states[8] = new State(-12,new int[]{-6,9});
    states[9] = new State(new int[]{125,10,145,13},new int[]{-7,11,-8,12});
    states[10] = new State(-7);
    states[11] = new State(-10);
    states[12] = new State(-11);
    states[13] = new State(new int[]{137,14,147,29,150,149,144,156,155,163,140,26,148,27,151,28},new int[]{-9,168,-18,22});
    states[14] = new State(new int[]{155,25,140,26,148,27,151,28},new int[]{-9,15,-18,22});
    states[15] = new State(new int[]{155,16});
    states[16] = new State(new int[]{61,17});
    states[17] = new State(new int[]{156,20,157,21},new int[]{-10,18});
    states[18] = new State(new int[]{59,19});
    states[19] = new State(-13);
    states[20] = new State(-14);
    states[21] = new State(-15);
    states[22] = new State(new int[]{91,23,155,-31});
    ...
    states[29] = new State(new int[]{155,25,140,26,148,27,151,28},new int[]{-9,30,-18,22});
    states[30] = new State(new int[]{155,31});
    states[31] = new State(new int[]{40,32});
    states[32] = new State(new int[]{155,25,140,26,148,27,151,28,41,-26},new int[]{-14,33,-16,143,-17,148,-9,146,-18,22});
    ...
    states[37] = new State(new int[]{125,38,155,112,139,122,152,130,135,135,146,137,123,36,59,142},new int[]{-19,39,-26,40,-20,41,-15,141});
    states[38] = new State(-54);
    states[39] = new State(-58);
    states[40] = new State(-59);
    states[41] = new State(new int[]{61,42,40,104,153,108,154,110});
    states[42] = new State(new int[]{45,71,155,80,156,89,157,90,141,93,40,100},new int[]{-21,43,-20,73});
    ...
    states[45] = new State(new int[]{45,71,155,80,156,89,157,90,141,93,40,100},new int[]{-21,46,-20,73});
    ...
    states[47] = new State(new int[]{45,71,155,80,156,89,157,90,141,93,40,100},new int[]{-21,48,-20,73});
    ...
    states[49] = new State(new int[]{45,71,155,80,156,89,157,90,141,93,40,100},new int[]{-21,50,-20,73});
    ...
    states[51] = new State(new int[]{45,71,155,80,156,89,157,90,141,93,40,100},new int[]{-21,52,-20,73});
    ...
    states[53] = new State(new int[]{45,71,155,80,156,89,157,90,141,93,40,100},new int[]{-21,54,-20,73});
    ...
    states[55] = new State(new int[]{45,71,155,80,156,89,157,90,141,93,40,100},new int[]{-21,56,-20,73});
    ...
    states[57] = new State(new int[]{45,71,155,80,156,89,157,90,141,93,40,100},new int[]{-21,58,-20,73});
    ...
    states[59] = new State(new int[]{45,71,155,80,156,89,157,90,141,93,40,100},new int[]{-21,60,-20,73});
    ...
    states[61] = new State(new int[]{45,71,155,80,156,89,157,90,141,93,40,100},new int[]{-21,62,-20,73});
    ...
    states[63] = new State(new int[]{45,71,155,80,156,89,157,90,141,93,40,100},new int[]{-21,64,-20,73});
    ...
    states[65] = new State(new int[]{45,71,155,80,156,89,157,90,141,93,40,100},new int[]{-21,66,-20,73});
    states[66] = new State(-70);
    states[67] = new State(new int[]{45,71,155,80,156,89,157,90,141,93,40,100},new int[]{-21,68,-20,73});
    states[68] = new State(-71);
    states[69] = new State(new int[]{45,71,155,80,156,89,157,90,141,93,40,100},new int[]{-21,70,-20,73});
    states[70] = new State(-72);
    states[71] = new State(new int[]{45,71,155,80,156,89,157,90,141,93,40,100},new int[]{-21,72,-20,73});
    ...
    states[74] = new State(new int[]{45,71,155,80,156,89,157,90,141,93,40,100,41,-48},new int[]{-22,75,-24,77,-21,103,-20,73});
    states[75] = new State(new int[]{41,76});
    states[76] = new State(-75);
    states[77] = new State(new int[]{44,78,41,-49});
    states[78] = new State(new int[]{45,71,155,80,156,89,157,90,141,93,40,100},new int[]{-21,79,-20,73});
    ...
    states[80] = new State(new int[]{46,82,91,85,40,-85,59,-85,128,-85,129,-85,130,-85,131,-85,133,-85,60,-85,132,-85,62,-85,43,-85,45,-85,42,-85,47,-85,37,-85,44,-85,41,-85,93,-85,61,-85,153,-85,154,-85},new int[]{-27,81});
    states[81] = new State(-82);
    states[82] = new State(new int[]{155,83});
    states[83] = new State(new int[]{46,82,91,85,40,-85,59,-85,128,-85,129,-85,130,-85,131,-85,133,-85,60,-85,132,-85,62,-85,43,-85,45,-85,42,-85,47,-85,37,-85,44,-85,41,-85,93,-85,61,-85,153,-85,154,-85},new int[]{-27,84});
    states[84] = new State(-83);
    states[85] = new State(new int[]{45,71,155,80,156,89,157,90,141,93,40,100},new int[]{-21,86,-20,73});
    states[86] = new State(new int[]{93,87,128,45,129,47,130,49,131,51,133,53,60,55,132,57,62,59,43,61,45,63,42,65,47,67,37,69});
    states[87] = new State(new int[]{46,82,91,85,40,-85,59,-85,128,-85,129,-85,130,-85,131,-85,133,-85,60,-85,132,-85,62,-85,43,-85,45,-85,42,-85,47,-85,37,-85,44,-85,41,-85,93,-85,61,-85,153,-85,154,-85},new int[]{-27,88});
    ...
    states[91] = new State(new int[]{155,92});
    states[92] = new State(-78);
    states[93] = new State(new int[]{155,94});
    states[94] = new State(new int[]{40,95,91,97});
    states[95] = new State(new int[]{41,96});
    states[96] = new State(-79);
    states[97] = new State(new int[]{45,71,155,80,156,89,157,90,141,93,40,100},new int[]{-21,98,-20,73});
    ...
    states[100] = new State(new int[]{45,71,155,80,156,89,157,90,141,93,40,100},new int[]{-21,101,-20,73});
    ...
    states[104] = new State(new int[]{45,71,155,80,156,89,157,90,141,93,40,100,41,-48},new int[]{-22,105,-24,77,-21,103,-20,73});
    ...
    states[112] = new State(new int[]{91,117,46,82,155,121,61,-85,40,-85,153,-85,154,-85},new int[]{-27,81,-13,113});
    states[113] = new State(new int[]{59,114,44,115});
    states[114] = new State(-55);
    states[115] = new State(new int[]{155,116});
    states[116] = new State(-19);
    states[117] = new State(new int[]{93,118,45,71,155,80,156,89,157,90,141,93,40,100},new int[]{-21,86,-20,73});
    states[118] = new State(new int[]{155,121},new int[]{-13,119});
    ...
    states[123] = new State(new int[]{45,71,155,80,156,89,157,90,141,93,40,100},new int[]{-21,124,-20,73});
    states[124] = new State(new int[]{41,125,128,45,129,47,130,49,131,51,133,53,60,55,132,57,62,59,43,61,45,63,42,65,47,67,37,69});
    states[125] = new State(new int[]{155,80,139,122,152,130,135,135,146,137,123,36,59,142},new int[]{-19,126,-20,41,-15,141});
    states[126] = new State(new int[]{138,128,125,-53,155,-53,139,-53,152,-53,135,-53,146,-53,123,-53,59,-53},new int[]{-23,127});
    states[127] = new State(-41);
    states[128] = new State(new int[]{155,80,139,122,152,130,135,135,146,137,123,36,59,142},new int[]{-19,129,-20,41,-15,141});
    states[129] = new State(-52);
    states[130] = new State(new int[]{40,131});
    states[131] = new State(new int[]{45,71,155,80,156,89,157,90,141,93,40,100},new int[]{-21,132,-20,73});
    states[132] = new State(new int[]{41,133,128,45,129,47,130,49,131,51,133,53,60,55,132,57,62,59,43,61,45,63,42,65,47,67,37,69});
    states[133] = new State(new int[]{155,80,139,122,152,130,135,135,146,137,123,36,59,142},new int[]{-19,134,-20,41,-15,141});
    states[134] = new State(-42);
    states[135] = new State(new int[]{59,136});
    states[136] = new State(-43);
    states[137] = new State(new int[]{59,138,45,71,155,80,156,89,157,90,141,93,40,100},new int[]{-21,139,-20,73});
    ...
    states[144] = new State(new int[]{155,25,140,26,148,27,151,28},new int[]{-17,145,-9,146,-18,22});
    states[145] = new State(-29);
    states[146] = new State(new int[]{155,147});
    states[147] = new State(-30);
    states[148] = new State(-28);
    states[149] = new State(new int[]{155,25,140,26,148,27,151,28},new int[]{-9,150,-18,22});
    states[150] = new State(new int[]{155,151});
    states[151] = new State(new int[]{40,152});
    states[152] = new State(new int[]{155,25,140,26,148,27,151,28,41,-26},new int[]{-14,153,-16,143,-17,148,-9,146,-18,22});
    states[153] = new State(new int[]{41,154});
    states[154] = new State(new int[]{123,36},new int[]{-15,155});
    states[155] = new State(-22);
    states[156] = new State(new int[]{155,25,140,26,148,27,151,28},new int[]{-9,157,-18,22});
    states[157] = new State(new int[]{155,158});
    states[158] = new State(new int[]{40,159});
    states[159] = new State(new int[]{155,25,140,26,148,27,151,28,41,-26},new int[]{-14,160,-16,143,-17,148,-9,146,-18,22});
    states[160] = new State(new int[]{41,161});
    states[161] = new State(new int[]{123,36},new int[]{-15,162});
    states[162] = new State(-23);
    states[163] = new State(new int[]{40,164,91,-33,155,-33});
    states[164] = new State(new int[]{155,25,140,26,148,27,151,28,41,-26},new int[]{-14,165,-16,143,-17,148,-9,146,-18,22});
    states[165] = new State(new int[]{41,166});
    states[166] = new State(new int[]{123,36},new int[]{-15,167});
    states[167] = new State(-24);
    states[168] = new State(new int[]{155,169});
    states[169] = new State(new int[]{40,170});
    states[170] = new State(new int[]{155,25,140,26,148,27,151,28,41,-26},new int[]{-14,171,-16,143,-17,148,-9,146,-18,22});
    states[171] = new State(new int[]{41,172});
    states[172] = new State(new int[]{123,36},new int[]{-15,173});
    states[173] = new State(-25);
    states[174] = new State(new int[]{136,175});
    states[175] = new State(new int[]{155,176});
    states[176] = new State(new int[]{123,177});
    states[177] = new State(-12,new int[]{-6,178});
    states[178] = new State(new int[]{125,179,145,13},new int[]{-7,11,-8,12});
    states[179] = new State(new int[]{58,180,136,-8,145,-8,127,-8});
    states[180] = new State(new int[]{155,181});
    states[181] = new State(-9);
    states[182] = new State(-6);
    states[183] = new State(new int[]{155,184});
    states[184] = new State(new int[]{59,185});
    states[185] = new State(new int[]{149,183,136,-3,145,-3},new int[]{-3,186});
    ...
    rules[4] = new Rule(-3, new int[]{149,155,59,-3});
    rules[5] = new Rule(-4, new int[]{-4,-5});
    rules[6] = new Rule(-4, new int[]{-5});
    rules[7] = new Rule(-5, new int[]{136,155,123,-6,125});
    rules[8] = new Rule(-5, new int[]{145,136,155,123,-6,125});
    rules[9] = new Rule(-5, new int[]{145,136,155,123,-6,125,58,155});
    rules[10] = new Rule(-6, new int[]{-6,-7});
    rules[11] = new Rule(-6, new int[]{-6,-8});
    rules[12] = new Rule(-6, new int[]{});
    rules[13] = new Rule(-7, new int[]{145,137,-9,155,61,-10,59});
    rules[14] = new Rule(-10, new int[]{156});
    rules[15] = new Rule(-10, new int[]{157});
    rules[16] = new Rule(-11, new int[]{-11,-12});
    rules[17] = new Rule(-11, new int[]{});
    rules[18] = new Rule(-12, new int[]{145,-9,-13,59});
    rules[19] = new Rule(-13, new int[]{-13,44,155});
    rules[20] = new Rule(-13, new int[]{155});
    rules[21] = new Rule(-8, new int[]{145,147,-9,155,40,-14,41,-15});
    rules[22] = new Rule(-8, new int[]{145,150,-9,155,40,-14,41,-15});
    rules[23] = new Rule(-8, new int[]{145,144,-9,155,40,-14,41,-15});
    rules[24] = new Rule(-8, new int[]{145,155,40,-14,41,-15});
    rules[25] = new Rule(-8, new int[]{145,-9,155,40,-14,41,-15});
    ...
    rules[30] = new Rule(-17, new int[]{-9,155});
    rules[31] = new Rule(-9, new int[]{-18});
    rules[32] = new Rule(-9, new int[]{-18,91,93});
    rules[33] = new Rule(-18, new int[]{155});
    rules[34] = new Rule(-18, new int[]{140});
    rules[35] = new Rule(-18, new int[]{148});
    rules[36] = new Rule(-18, new int[]{151});
    rules[37] = new Rule(-19, new int[]{-20,61,-21,59});
    rules[38] = new Rule(-19, new int[]{-20,40,-22,41,59});
    rules[39] = new Rule(-19, new int[]{-20,153,59});
    rules[40] = new Rule(-19, new int[]{-20,154,59});
    rules[41] = new Rule(-19, new int[]{139,40,-21,41,-19,-23});
    rules[42] = new Rule(-19, new int[]{152,40,-21,41,-19});
    rules[43] = new Rule(-19, new int[]{135,59});
    rules[44] = new Rule(-19, new int[]{146,59});
    rules[45] = new Rule(-19, new int[]{146,-21,59});
    ...
    rules[52] = new Rule(-23, new int[]{138,-19});
    rules[53] = new Rule(-23, new int[]{});
    rules[54] = new Rule(-15, new int[]{123,-25,125});
    rules[55] = new Rule(-26, new int[]{155,-13,59});
    rules[56] = new Rule(-26, new int[]{155,91,93,-13,59});
    ...
    rules[76] = new Rule(-21, new int[]{156});
    rules[77] = new Rule(-21, new int[]{157});
    rules[78] = new Rule(-21, new int[]{157,46,155});
    rules[79] = new Rule(-21, new int[]{141,155,40,41});
    rules[80] = new Rule(-21, new int[]{141,155,91,-21,93});
    rules[81] = new Rule(-21, new int[]{40,-21,41});
    rules[82] = new Rule(-20, new int[]{155,-27});
    rules[83] = new Rule(-27, new int[]{46,155,-27});
